...
{
    public partial class SupplierCard : Form
    {
        ...
        public void SetParameters(Boolean New, Supplier supplier)
        {
            switch (New)
            {
                case true:
                ...
                case false:
                    ...
                    textBoxId.Text = Convert.ToString(supplier.Id);
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                supplier.Id = Convert.ToInt32(textBoxId.Text);
                supplier.Name = textBoxName.Text;
                supplier.Phone = textBoxPhone.Text;
                supplierRepository.UpdateSupplier(supplier);

                AutoClosingMessageBox.Show("You have successfully updated a Supplier!", "Congratulations!", 1700);
                this.Close();
                }
                catch (Exception)
                {
        ...
        private void buttonInsert_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You can enter only digits while you insert your phone number!", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
                {
                try
                {
                    ...
                    AutoClosingMessageBox.Show("You have successfully added a Supplier!", "Congratulations!", 1700);
                    this.Close();
                }
                catch (Exception)
                {
        ...
        private void SupplierCard_Activated(object sender, EventArgs e)
        {
            textBoxName.Focus();
        }
    }
